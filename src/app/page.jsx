            ...
            <div className="container mx-auto relative z-10 pt-40">
              <div className="max-w-4xl">
                <div className="flex flex-col items-start mb-8 pl-4 md:pl-8">
                  <div
                    ref={imageRef}
                    className="relative w-48 h-48 group mb-8"
                  ...
                  >
                    ...
                    <div
                      className={`absolute -top-20 left-1/2 transform -translate-x-1/2 transition-all duration-300 ${
                        showMessage
                          ? "opacity-100 scale-100"
                          : "opacity-0 scale-95"
                      }`}
                    >
                      <div className="relative bg-[#131631] rounded-xl px-6 py-3 border border-[#c4a962]/30 shadow-[0_0_15px_rgba(196,169,98,0.1)] backdrop-blur-sm">
                        <div className="absolute inset-0 rounded-xl overflow-hidden">
                          <div className="absolute inset-0 bg-gradient-to-r from-[#c4a962]/0 via-[#c4a962]/20 to-[#c4a962]/0 animate-shine"></div>
                        </div>
  
                        <span className="relative z-10 text-[#c4a962] font-inter text-sm tracking-wide">
                          Stay away!
                        </span>
            ...
            <div className="container mx-auto pt-20">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12">
                {sections.projects.items.map((project, index) => (
                  ...
                  >
                    {project.image && (
                      <div className="mb-6 overflow-hidden rounded-lg border border-[#c4a962]/20">
                        <img
                          src={project.image}
                          alt={project.title}
